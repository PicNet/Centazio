...
public class SqliteSimulationCoreStorageDbContext(string connstr) : AbstractSimulationCoreStorageDbContext(AbstractTestingCoreStorageDbContext.DEFAULT_CORE_SCHEMA_NAME, nameof(Core.Ctl).ToLower()) {
