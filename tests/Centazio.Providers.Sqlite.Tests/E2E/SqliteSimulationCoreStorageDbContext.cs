...
public class SqliteSimulationCoreStorageDbContext(string dbfile) : AbstractSimulationCoreStorageDbContext(AbstractTestingCoreStorageDbContext.DEFAULT_CORE_SCHEMA_NAME, nameof(Core.Ctl).ToLower()) {
