...
public class DateTimeUsageTests {
  ...
  [Test] public void Test_no_DateTime_usage_all_dates_should_be_from_UtcDate() {
    ...
    InspectUtils.CsFiles(null, "DateTimeUsageTests.cs", "UtcDate.cs", "ClickUpApiTests.cs", "function.cs", "E2EEnvironment.cs", "AwsEventBridgeChangesNotifierTests.cs", "AsyncUtils.cs").ForEach(file => {
