...
public class CheckEnumerableUsageStandards {
  ...
  [Test] public void Test_no_use_of_IEnumerable() {
    ...
    InspectUtils.CsFiles(null, "GlobalEnumerableExtensionMethods.cs", "CheckEnumerableUsageStandards.cs", "EpochTracker.cs", "Rng.cs", "E2EEnvironment.cs", "WriteHelpers.cs", "Json.cs", "CentazioDbContext.cs", "AppSheetApi.cs", "Templater.cs", "InProcessChangesNotifier.cs")
        .ForEach(file => {
