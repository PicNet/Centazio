...
public interface ICoreToSystemMapStore : IAsyncDisposable {
  ...
  Task<(List<CoreAndPendingCreateMap> Created, List<CoreAndPendingUpdateMap> Updated)> GetNewAndExistingMappingsFromCores(List<ICoreEntity> cores, SystemName external);
...
public abstract class AbstractCoreToSystemMapStore : ICoreToSystemMapStore {
  ...
  public abstract Task<(List<CoreAndPendingCreateMap> Created, List<CoreAndPendingUpdateMap> Updated)> GetNewAndExistingMappingsFromCores(List<ICoreEntity> cores, SystemName external);
