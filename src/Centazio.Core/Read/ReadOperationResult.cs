...
public abstract record ReadOperationResult(
  ...
  public static ReadOperationResult Create(List<RawJsonDataWithCorrelationId> lst, DateTime nextcheckpoint, EOperationAbortVote abort = EOperationAbortVote.Continue) => 
...
internal record ListReadOperationResult(List<RawJsonDataWithCorrelationId> PayloadList, DateTime SpecificNextCheckpoint, EOperationAbortVote AbortVote = EOperationAbortVote.Continue) 
    : ReadOperationResult(
  ...
  public List<RawJsonDataWithCorrelationId> PayloadList { get; } = 
