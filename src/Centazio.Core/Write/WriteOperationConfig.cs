...
public record WriteOperationConfig(
    ...
    WriteEntitiesToTargetSystemHandler WriteEntitiesToTargetSystem) : OperationConfig(CoreEntityTypeName, [ new(CoreEntityTypeName, LifecycleStage.Defaults.Promote) ], Cron), ILoggable {
