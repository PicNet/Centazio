...
public interface ICoreToSystemMapStore : IAsyncDisposable {
  ...
  /// a target system.
  /// </summary>
  Task<Dictionary<SystemEntityId, CoreEntityId>> GetPreExistingSystemIdToCoreIdMap(SystemName system, CoreEntityType coretype, List<ICoreEntity> entities);
...
public abstract class AbstractCoreToSystemMapStore : ICoreToSystemMapStore {
  ...
  public abstract Task<Dictionary<SystemEntityId, CoreEntityId>> GetPreExistingSystemIdToCoreIdMap(SystemName system, CoreEntityType coretype, List<ICoreEntity> entities);
