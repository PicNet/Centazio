...
public record StagedEntity {
  ...
  public static StagedEntity Create(SystemName system, SystemEntityTypeName systype, DateTime staged, ValidString data, StagedEntityChecksum checksum) => PrivateCreateWithId(Guid.CreateVersion7(), system, systype, staged, data, checksum);
  public static StagedEntity PrivateCreateWithId(Guid id, SystemName system, SystemEntityTypeName systype, DateTime staged, ValidString data, StagedEntityChecksum checksum) => new(id, system, systype, staged, data, checksum);
